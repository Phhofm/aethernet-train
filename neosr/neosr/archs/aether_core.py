    ...
    def __init__(self, scale: int, in_channels: int):
        ...
        if (scale & (scale - 1)) == 0 and scale != 1:
            ...
            for i in range(num_ups):
                next_channels = self.out_channels if (i == num_ups - 1) else (current_channels // 2) & -2
...
class AetherNet(nn.Module):
    ...
    def prepare_qat(self, per_channel: bool = False):
        ...
        # Fuse first, then prepare. This is crucial.
        self.fuse_model()
        
        # Set quantization flags BEFORE preparing
